...
USBD_StatusTypeDef USBD_LL_Init(USBD_HandleTypeDef *pdev)
{
  ...
  //MAX 4KBytes/1KWords || 0x1000Bytes/0x400Words
	HAL_PCDEx_SetRxFiFo(&hpcd_USB_OTG_HS, 0x40);//SHARE OUT    ctrl    					 [0x40 words]
  HAL_PCDEx_SetTxFiFo(&hpcd_USB_OTG_HS, 0, 0x40); //IN 0     ctrl              [0x40 words]
	...
	HAL_PCDEx_SetTxFiFo(&hpcd_USB_OTG_HS, 2, 0x10); //IN 2     unused          	 [0x10 words]
  HAL_PCDEx_SetTxFiFo(&hpcd_USB_OTG_HS, 3, 0x300);//IN 3     micphone          [0x300 words]//768B * 4 PACKET
  }
  return USBD_OK;
}
